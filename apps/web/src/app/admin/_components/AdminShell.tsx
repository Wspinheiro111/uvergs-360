...
type IconName = "home" | "network" | "events" | "finance" | "communication" | "flags" | "users" | "audit";
...
const NAV_GROUPS: NavGroup[] = [
  { label: "Visão geral", items: [{ href: "/admin", label: "Painel", icon: "home" }] },
  {
    ...
    items: [
      ...
      { href: "/admin/comunicacao", label: "Comunicação", icon: "communication" },
    ],
  },
  {
    label: "Governança",
...
function NavIcon({ name }: { name: IconName }) {
  const paths: Record<IconName, React.ReactNode> = {
    ...
    communication: <><path d="M4 5h16v12H8l-4 4V5Z" /><path d="M8 9h8M8 13h5" /></>,
